...
Crawl websites and audit accessibility issues with actionable fix suggestions using [Spider Cloud](https://spider.cloud) — the fastest web crawling infrastructure.

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fspider-rs%2Fspider-a11y-checker&env=NEXT_PUBLIC_SUPABASE_URL,NEXT_PUBLIC_SUPABASE_ANON_KEY)
...
```bash
git clone https://github.com/spider-rs/spider-a11y-checker.git
cd spider-a11y-checker
```
